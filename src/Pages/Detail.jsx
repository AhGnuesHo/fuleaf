          ...
          <SearchSection>
            ...
            >
              <div className="relative">
                <input
                  class="w-full bg-[#f8f8f8] h-[60px] rounded-[43px] py-[16px] pr-[55px] pl-[32px] text-[20px] tracking-[-1px]"
                  type="text"
        ...
        <div className="flex flex-row mb-[80px] pt-[60px]">
          <div className="w-[50%] mr-[60px] my-0 ml-0 relative block">
            <img
              ...
              src="https://huga.s3.ap-northeast-2.amazonaws.com/plantImages/157163994358901_folia_folia_51132336_306464350061981_8687623975632233786_n.jpg"
            />
          </div>
          <div className="w-[50%] pt-[8px] ">
            ...
            <h3 className="text-[14px] font-[500] tracking-[-0.42px] mb-[50px] text-[#333] leading-[1.64]">
              칼라디움은 전 세계 2,000종 이상, 다양한 색과 무늬를 가진
              식물이에요. 잎이 크고 화려한 무늬를 가졌어요. 꽃자체는 아름답지
              않아서 잎을 보기 위해 키우는 식물이랍니다. 알뿌리식물(구근식물)인
              칼라디움의 잎의 크기는 뿌리와 비슷하게 자라요. 다른 식물들과
              다르게 월동을 하기 위해서는 잎이 시들기 시작하는 가을철에는 줄기와
              잎을 모두 잘라주시고, 뿌리(구근)을 캐서 5~15 ℃에 4~5개월 정도
              유지한 뒤 모래나 톱밥에 파묻어야 해요.
            </h3>
            <Ul>
